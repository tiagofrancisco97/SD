    ...
    while(strcmp(token, "quit") != 0){
        ...
        if(strcmp(token, "get") == 0){
            ...
            if (key != NULL) {
                ...
                struct data_t *data = rtable_get(key);
                printf("value: %s\n", data->data);
        ...
        if(strcmp(token, "verify") == 0){
            ...
            if(op == NULL){
                ...
                int boolean = rtable_verify(atoi(op));
                if (boolean == 0) {
